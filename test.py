...
def alok():
    try:
        ...
        os.system("clear")
        logo()
        print(' [%s!%s] Contact Admin if anyone is buying and selling SC Meta. this SC %sFILE-404%s'%(M,N,H,N))
        ...
        if pil =="":
            ...
            print('%s══════════════════════════════════════════'%(N))
            print(' %s[%s!%s] ENTER %sUSERNAME & PASSWORD%s To enter the tools!'%(N,M,N,H,N))
        else:
