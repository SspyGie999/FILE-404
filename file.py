...
class login():
	...
	def login_WALA(self):
		...
		print('(02) login with cookies (best)')
...
def main_menu():
	...
	print(" Code Teaches You How To Face Big Problems ! ")
	print('\x1b[1;92m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
	print('《1》 𝙲𝚛𝚎𝚊𝚝𝚎 𝙵𝚒𝚕𝚎 𝚂𝚒𝚖𝚙𝚕𝚎 ')
	print('《2》 𝙲𝚛𝚎𝚊𝚝𝚎 𝙵𝚒𝚕𝚎 𝚄𝚗𝚕𝚒𝚖𝚒𝚝𝚎𝚍 ')
	print('《3》 𝙲𝚛𝚎𝚊𝚝𝚎 𝙽𝚎𝚠 𝙸𝚍 𝙵𝚛𝚘𝚖 𝙵𝚒𝚕𝚎 ')
	print('《4》 𝚁𝚎𝚖𝚘𝚟𝚎 𝙲𝚘𝚘𝚔𝚒𝚎 ')
	print('《0》 𝙴𝚡𝚒𝚝 𝙵𝚒𝚕𝚎 ')
	print('\x1b[1;92m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
	menu = input('《</>》𝙸𝚗𝚙𝚞𝚝 𝙼𝚊𝚔𝚎 : ')
	if menu in ['01','1']:
...
class file_create_menu():
	...
	def file_unlimmited(self):
		os.system('clear');print(logo)
		limit = input(" 𝙷𝚘𝚠 𝙼𝚊𝚗𝚢 𝙸𝚍𝚣 𝚈𝚘𝚞 𝚆𝚊𝚗𝚝 𝚃𝚘 𝙰𝚍𝚍? ")
		print('▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
		print('𝙴𝚡𝚊𝚖𝚙𝚕𝚎 : /sdcard/404.txt ')
		save_as = input(" 𝚂𝚊𝚟𝚎 𝙵𝚒𝚕𝚎 𝙰𝚜 : ")
		if not save_as == '/sdcard/':
			os.system(f'rm -rf {save_as}')
			open(save_as,'w')
		os.system('clear');print(logo)
		sepr = input(' 𝙳𝚘 𝚈𝚘𝚞 𝚆𝚊𝚗𝚝 𝚃𝚘 𝚂𝚎𝚙𝚊𝚛𝚊𝚝𝚎 𝙸𝚍𝚣? (y/n) : ')
		if sepr in ['y','Y']:
			sep.append('y')
		...
		for i in range(int(limit)):
			uid = input(" 𝙸𝚗𝚙𝚞𝚝 𝙸𝚍𝚣 {} : ".format(i+1))
			try:
				headers = {"X-Graphql-Client-Library": "graphservice", "X-Graphql-Request-Purpose": "fetch",
						   "X-Fb-Privacy-Context": "2368177546817046", "X-Fb-Background-State": "1",
						   "X-Fb-Net-Hni": "41001", "X-Fb-Sim-Hni": "41001",
